...
**Công nghệ:**
- AI: **Groq** (Llama 3.3 – miễn phí, cực nhanh) + hỗ trợ Gemini
...
| `AI_PROVIDER` | `groq` | Bắt buộc |
| `GROQ_API_KEY` | Key lấy từ https://console.groq.com/keys | Bắt buộc |
| `DATABASE_URL` | Connection string từ Neon | Bắt buộc |
| `WEBHOOK_SECRET` | `abc123xyz789secret` (tự đặt chuỗi bất kỳ) | Bắt buộc |
| `GROQ_MODEL` | `llama-3.3-70b-versatile` | Tùy chọn |
